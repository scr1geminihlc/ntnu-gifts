          ...
          {filteredGifts.map((gift) => (
            <div key={gift.id} className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow cursor-pointer flex flex-col relative" onClick={() => openGiftDetails(gift)}>
              ...
              <div className="h-48 overflow-hidden relative bg-slate-50 flex items-center justify-center p-2">
                <img src={gift.image} alt={gift.name} className="max-w-full max-h-full object-contain" />
              ...
              <div className="p-5 flex-1 flex flex-col justify-between">
                ...
                <button className="mt-4 w-full py-2 bg-slate-50 text-slate-700 rounded-lg border border-slate-200 font-medium hover:bg-slate-100 transition-colors flex items-center justify-center gap-2">
